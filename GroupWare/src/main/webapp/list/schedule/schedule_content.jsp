...
<link rel="stylesheet" href="<c:url value="/resources/css/board_boardNum.css?v=4"/>">
</head>
<body>
	...
	<div class="board_boardNum">
		...
		<div class="btn">
			...
			<a href="<c:url value="/scheduleDepBack.do?number=${number}"/>" class="btn btn-primary">되돌아가기</a>
			<%
